...
public class DetailsVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = intent.getExtras().getString("ulr");
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (fullscreen){
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(DetailsVideoActivity.this,R.drawable.ic_fullscreen_expand));
                    ...
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(DetailsVideoActivity.this,R.drawable.ic_fullscreen_skrink));
    ...
    protected void onResume() {
        ...
        if (Util.SDK_INT >= 25 || player == null ){
            //  initializeplayer();
